...
@Autonomous
public class Score9Red extends OpMode {
    ...
    private final Pose prepareIntakePose2 = new Pose(96,84,Math.toRadians(0));
    private final Pose pickUpPose2 = new Pose(130,84,Math.toRadians(0));
    private final Pose endPose = new Pose(84, 55, Math.toRadians(0));
    private Path scorePreload;
    private Path endAuton;
    private PathChain score1, score2;
    ...
    public void autonomousPathUpdate() {
        switch (pathState){
            ...
            case 3: //adjust balls 1
                adjustBalls(4, score1);
                break;
            case 4: //go to shooting pose and shoot
                shootBalls(5);
                break;
            case 5: //pickup balls 2
                if(!follower.isBusy()) {
                ...
                break;
            case 6: //adjust balls 2
                intakeMotor.setPower(0);
                adjustBalls(7, score2);
                break;
            case 7: //score second round of balls
                shootBalls(8);
                break;
            case 8: //go to end position
                if(!follower.isBusy()) {
    ...
    private void adjustBalls(int nextState, PathChain path){
        if (!follower.isBusy()) {
